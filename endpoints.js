...
If this value is entered the call returns the cumulated visibility for all URLs that contain the string entered here.Format: domain.tld, subdomain.domain.tld, domain.tld/directory/
	 ...
	 * @param {searchmetrics~ApiCallback} callback
	 */
	searchmetrics.prototype.projectOrganicGetListPositionSpreadHistoric = function(callback) {
		this.request('ProjectOrganicGetListPositionSpreadHistoric', callback);
	}
...
Must be a multiple of allowed values for the parameter "limit"Format: integer
	 ...
	 * @param {searchmetrics~ApiCallback} callback
	 */
	searchmetrics.prototype.projectOrganicGetListSeoVisibilityHistoric = function(callback) {
		this.request('ProjectOrganicGetListSeoVisibilityHistoric', callback);
	}
